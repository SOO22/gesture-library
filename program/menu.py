...
class MainMenu(Frame):
    """groups all the contents of the program menu"""

    def __init__(self, parent):
        """available images and buttons"""
    ...
    def create_folder_list(self, parent):
        """create and contain the image folders and a scroll bar"""
    ...
    def create_time_selection(self, parent):
        """create radio buttons for drawing times per image"""
    ...
    def create_image_selection(self, parent):
        """create radio buttons for amount of images in a single session"""
    ...
    def prepare_session(self):
        # self.topFrame
        valid = False
        valid = self.validate_number(self.menuTime, self.menuTimeTxt) and self.validate_number(self.menuImages, self.menuImagesTxt)
        if valid:
            self.images = self.menuImages.get()
            self.time = self.menuTime.get()
